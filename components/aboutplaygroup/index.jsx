const Aboutplaygroup = () => (
    <aboutplaygroup>
  

        <div className="w3-container" id="about">
            <div className="w3-content" style={{maxWidth: '700px'}}>
              <h4 className="w3-center w3-padding-32"><span className="w3-tag w3-grey w3-wide"><b>ABOUT PLAYGROUP</b></span></h4>
